...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2016 a las 14:23:29
...
(7, 1, 201, 123, 'nose', 240, 504000),
(8, 2, 202, 123, 'nose', 250, 625000);
...
--
ALTER TABLE `tbl_rol_permisos`
  MODIFY `Id_Rol_Permisos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
