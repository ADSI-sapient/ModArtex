...
<html>
<head>
    <title>Reporte Existencias de Producto Terminado</title>
    <style>
        @media print {
...
<div id="wrapper"> 
    ...
    <h1 class="titu">Existencias de Producto Terminado</h1>
...
$time = time();
$dompdf->stream("Reporte Producto Terminado - ".date("d-m-Y (H:i:s)", $time), ["Attachment"=>0]);
?>