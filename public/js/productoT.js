     ...
     function Salida(){
          ...
          $("#tablaProducto tbody tr").each(function(){
            ...
            if ($("#chkSali"+valor).prop("checked")) {
              ...
              +$(this).find("td").eq(2).html()+"'></td><td><input id='Salida' type='number' name='salida[]'></td><td><textarea rows='1' cols='40' id='descripcion'  name='descripcion[]' type='text'></textarea></td></tr>";
